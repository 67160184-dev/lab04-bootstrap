...
const blogData = {
 ...
 มาตรฐานนี้นําเสนอฟีเจอร์ใหม่หลายอย่างที่ช่วยให้การพัฒนาเว็บไซต์มีประสิทธิภาพมากขึ้น
 </p>
...
r>
 4. <strong>Canvas and SVG:</strong> สําหรับการวาดภาพ<br>
 5. <strong>Local Storage:</strong> เก็บข้อมูลในฝั่ง client
 </p>
 <h3>ข้อดีของการใช้ HTML5</h3>
 <p>
 - ทําให้เว็บไซต์เข้ากันได้กับอุปกรณ์ต่างๆได้ดีขึ้น<br>
 ...
 <h3>สรุป</h3>
 <p>
 HTML5 เป็นมาตรฐานที่สําคัญและเป็นพื้นฐานของการพัฒนาเว็บสมัยใหม่
 ...
 <p>
 CSS Grid และ Flexbox เป็นสองเครื่องมือที่สําคัญในการสร้างเลย์เอาต์ที่ทันสมัย
 ทั้งสองมีข้อดีและข้อเสียต่างกัน ลองมาเปรียบเทียบกันดู
 </p>
 <h3>Flexbox</h3>
 <p>
 Flexbox เหมาะสําหรับการจัดเรียงรายการในแนวเดียว (row หรือ column)<br>
 <strong>ข้อดี:</strong><br>
 - ใช้งานง่าย สําหรับ layout ที่ไม่ซับซ้อน<br>
 - ดีสําหรับการจัดเรียงรายการที่มีขนาดแตกต่างกัน<br>
 ...
 <h3>CSS Grid</h3>
 <p>
 CSS Grid เหมาะสําหรับการสร้าง layout ที่ซับซ้อนในสองมิติ<br>
 <strong>ข้อดี:</strong><br>
 - สามารถจัดการ layout 2D ได้อย่างมีประสิทธิภาพ<br>
 - ดีสําหรับ page layout ที่ซับซ้อน<br>
 - ลดความสับสน (confusion) ในโครงสร้าง HTML<br>
 <strong>ข้อเสีย:</strong><br>
 - การเรียนรู้ซับซ้อนกว่า Flexbox<br>
 - ไม่จําเป็นต้องใช้สําหรับ layout ที่ง่ายๆ
 </p>
 <h3>สรุป</h3>
 <p>
 เลือก Flexbox สําหรับ layout ที่ง่ายๆ และต้องการความยืดหยุ่น<br>
 เลือก CSS Grid สําหรับ page layout ที่ซับซ้อนหรือต้องการควบคุมได้ละเอียด<br>
 หรือใช้ทั้งคู่ร่วมกันสําหรับ layout ที่สมบูรณ์แบบ!
 </p>
 `,
  },
  3: {
 ...
 <p>
 ES6 (ECMAScript 2015) นําเสนอการเปลี่ยนแปลงครั้งใหญ่ให้กับ JavaScript
 ปัจจุบันนี้ JavaScript ยังคงพัฒนาต่อเรื่อยๆ มาทําความเข้าใจฟีเจอร์ใหม่ๆที่เป็นประโยชน์กัน
 </p>
 ...
 <p>
 ช่วยให้การจัดการ asynchronous code ทําได้ง่ายขึ้น
 </p>
 <h3>Modules</h3>
 <p>
 ...
 <p>
 1. <strong>Responsive Design:</strong> ทําให้เว็บไซต์ดูดีบนอุปกรณ์ทุกขนาด<br>
 2. <strong>Pre-built Components:</strong> ปุ่ม, บาร์นําทาง, การ์ด เป็นต้น<br>
 3. <strong>Utility Classes:</strong> ช่วยให้เราจัดตําแหน่งและจัดสไตล์ได้ง่าย<br>
 ...
 <h3>สรุป</h3>
 <p>
 Bootstrap 5 เป็นเครื่องมือที่ยอดเยี่ยมสําหรับนักพัฒนา frontend
 ลองใช้และค้นพบความสามารถของมันเพื่อเพิ่มประสิทธิภาพในการพัฒนา
 </p>
 `,
  },
  5: {
    title: "Web Responsive Design: สําเร็จในยุคมือถือ",
    author: "Admin",
    date: "11 ธันวาคม 2025",
    content: `
 <h1>Web Responsive Design: สําเร็จในยุคมือถือ</h1>
 <div class="blog-meta">
 ...
 <p>
 1. <strong>Mobile First:</strong> ออกแบบสําหรับมือถือก่อน แล้วขยายออกไป<br>
 ...
 <h3>สรุป</h3>
 <p>
 Responsive Design ไม่ใช่ตัวเลือก แต่เป็นความจําเป็นในการพัฒนาเว็บสมัยใหม่
 อย่าลืมทดสอบบนอุปกรณ์ที่แตกต่างกันเพื่อให้มั่นใจว่าเว็บไซต์ของคุณใช้งานได้ดีสําหรับทุกคน
 </p>
 `,
  },
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (registerForm) {
    registerForm.addEventListener("submit", function (e) {
      ...
      alert("สมัครสมาชิกสําเร็จ! ระบบจะนําคุณไปหน้า Login");
